...
function Model() {
  return (
    <div className="border-2 bg-black h-[745px] flex justify-end">
      <div className="w-[550px] bg-white my-20 px-10 py-10">
        <div className="pb-3 text-xl text-black flex justify-end items-center">
          <AiOutlineInfoCircle />
          <h3>Model</h3>
